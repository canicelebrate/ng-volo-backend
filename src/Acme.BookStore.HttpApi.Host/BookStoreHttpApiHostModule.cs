    ...
    public class BookStoreHttpApiHostModule : AbpModule
    {
        ...
        private void ConfigureLocalization()
        {
            Configure<AbpLocalizationOptions>(options =>
            {
                ...
                options.Languages.Add(new LanguageInfo("zh-Hans", "zh-Hans", "简体中文", "famfamfam-flags cn"));
                options.Languages.Add(new LanguageInfo("zh-Hant", "zh-Hant", "繁體中文", "famfamfam-flags hk"));
                options.Languages.Add(new LanguageInfo("en", "en", "English", "famfamfam-flags us"));
            });
        }
